  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>ด้านการเมือง การบริหาร การสำรวจข้อมูลขั้นพื้นฐาน <small>ครั้งที่ {{discoverySurvey.Survey.no}}</small></h2>
                      ...
                      <div id="step-5">
                        ...
                        <form class="form-horizontal form-label-left">
                          ...
                          {{no9_6}}
                                  ...
                                  <textarea class="form-control" rows="10" id="no9_6" maxlength="1000">{{no9_6}}</textarea>
