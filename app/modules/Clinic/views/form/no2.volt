          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>ด้านโครงสร้างพื้นฐาน การสำรวจข้อมูลขั้นพื้นฐาน <small>ครั้งที่ {{discoverySurvey.Survey.no}}</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a href="{{ url.get() }}clinic-admin/export-word/printformno2" role="button" aria-expanded="false"><i class="fa fa-print"></i></a></li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
        ...
        <table id="road" class="table table-striped table-bordered" style="clear: both">
          <tbody>
            ...
            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">สะพาน</label>
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">
                <a href="#" id="no2_1_6" data-type="text" data-pk="1" data-title="Enter username">{{no2_1_6}}</a>
              </label>
      ...
      <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="text-center">
                  <a  href="{{ url.get() }}clinic-admin/export-word/printformno2" id="btnPrint" class="btn btn-app" >
