...
class FormController extends Controller
{
    ...
    public function initialize()
    {
        ...
        if(!$this->session->has('discovery_surveyid')){
            ...
            if($discoverySurvey==null){
                $discoverySurvey = new DiscoverySurvey();
                $discoverySurvey->officeid  = $this->user->officeid;
                $discoverySurvey->surveyid  = 1;
                $discoverySurvey->status    = 0;
                $discoverySurvey->save();                
            }
            $this->session->set('surveyid', $discoverySurvey->Survey->id);
            $this->session->set('discovery_surveyid', $discoverySurvey->id);
        }else{
        ...
        $this->view->status = $discoverySurvey->status;
    }
