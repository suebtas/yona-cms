...
# Database: yona-cms
# Generation Time: 2016-07-12 08:36:51 +0000
# ************************************************************
...
VALUES
	...
	(3,1,'cc-admin','suebtas','suebtas@gmail.com','Suebtas Limsaihua','$2y$10$fQuBRWwRE74mQkycvcPEj.HiDh5f9GMZ3ORsayu8dl8S1q/8uDtfm',1);
...
CREATE TABLE `answer` (
  ...
  PRIMARY KEY (`id`),
  KEY `answer in survey` (`surveyid`),
  KEY `answer in question` (`questionid`),
  CONSTRAINT `answer in question` FOREIGN KEY (`questionid`) REFERENCES `question` (`id`),
  CONSTRAINT `answer in survey` FOREIGN KEY (`surveyid`) REFERENCES `discovery survey` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `approval` (
  ...
  PRIMARY KEY (`id`),
  KEY `approval on` (`surveyid`),
  KEY `user approval on` (`admin_userid`),
  KEY `approve in` (`sessionid`),
  CONSTRAINT `approval on` FOREIGN KEY (`surveyid`) REFERENCES `discovery survey` (`id`),
...
CREATE TABLE `comment` (
  ...
  `admin_userid` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `comment on` (`surveyid`),
  KEY `user comment on` (`admin_userid`),
  CONSTRAINT `comment on` FOREIGN KEY (`surveyid`) REFERENCES `discovery survey` (`id`),
...
CREATE TABLE `discovery survey` (
  ...
  PRIMARY KEY (`id`),
  KEY `do` (`officeid`),
  KEY `FKdiscovery 271783` (`surveyid`),
  CONSTRAINT `FKdiscovery 271783` FOREIGN KEY (`surveyid`) REFERENCES `survey` (`id`),
...
CREATE TABLE `office` (
  ...
  CONSTRAINT `mange by` FOREIGN KEY (`amphurid`) REFERENCES `amphur` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `office_boundary` (
  ...
  KEY `boundary office` (`officeid`),
  KEY `boundary area` (`boundaryid`),
  CONSTRAINT `boundary area` FOREIGN KEY (`boundaryid`) REFERENCES `boundary` (`id`),
  CONSTRAINT `boundary office` FOREIGN KEY (`officeid`) REFERENCES `office` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `session` (
  ...
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `comment in` (`commentid`),
  CONSTRAINT `comment in` FOREIGN KEY (`commentid`) REFERENCES `comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
