...
# Database: yona-cms
# Generation Time: 2016-09-27 09:26:57 +0000
# ************************************************************
...
CREATE TABLE `office` (
  ...
  `map` blob,
  `maptype` varchar(11) DEFAULT NULL,
  `mapsize` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `manage by` (`name`),
...
INSERT INTO `office` (`id`, `name`, `amphurid`, `map`, `maptype`, `mapsize`)
VALUES
	(1,'องค์การบริหารส่วนจังหวัดระยอง',1,NULL,NULL,NULL),
	(2,'เทศบาลนครระยอง',1,NULL,NULL,NULL),
	(3,'เทศบาลเมืองมาบตาพุด',1,NULL,NULL,NULL),
	(4,'เทศบาลตำบลแกลงกะเฉด',1,NULL,NULL,NULL),
	(5,'เทศบาลตำบลทับมา',1,NULL,NULL,NULL),
	(6,'เทศบาลตำบลบ้านเพ',1,NULL,NULL,NULL),
	(7,'เทศบาลตำบลน้ำคอก',1,NULL,NULL,NULL),
	(8,'เทศบาลตำบลเนินพระ',1,NULL,NULL,NULL),
	(9,'เทศบาลตำบลเชิงเนิน',1,NULL,NULL,NULL),
	(10,'องค์การบริหารส่วนตำบลนาตาขวัญ',1,NULL,NULL,NULL),
	(11,'องค์การบริหารส่วนตำบลบ้านแลง',1,NULL,NULL,NULL),
	(12,'องค์การบริหารส่วนตำบลสำนักทอง',1,NULL,NULL,NULL),
	(13,'องค์การบริหารส่วนตำบลกะเฉด',1,NULL,NULL,NULL),
	(14,'องค์การบริหารส่วนตำบลแกลง',1,NULL,NULL,NULL),
	(15,'องค์การบริหารส่วนตำบลตะพง',1,NULL,NULL,NULL),
	(16,'องค์การบริหารส่วนตำบลเพ',1,NULL,NULL,NULL),
	(17,'เทศบาลตำบลกองดิน',2,NULL,NULL,NULL),
	(18,'เทศบาลตำบลทุ่งควายกิน',2,NULL,NULL,NULL),
	(19,'เทศบาลตำบลบ้านนา',2,NULL,NULL,NULL),
	(20,'เทศบาลตำบลเมืองแกลง',2,NULL,NULL,NULL),
	(21,'เทศบาลตำบลเนินฆ้อ',2,NULL,NULL,NULL),
	(22,'เทศบาลตำบลสองสลึง',2,NULL,NULL,NULL),
	(23,'เทศบาลตำบลปากน้ำประแส',2,NULL,NULL,NULL),
	(24,'เทศบาลตำบลสุนทรภู่',2,NULL,NULL,NULL),
	(25,'องค์การบริหารส่วนตำบลกระแสบน',2,NULL,NULL,NULL),
	(26,'องค์การบริหารส่วนตำบลชากโดน',2,NULL,NULL,NULL),
	(27,'องค์การบริหารส่วนตำบลทางเกวียน',2,NULL,NULL,NULL),
	(28,'องค์การบริหารส่วนตำบลทุ่งควายกิน',2,NULL,NULL,NULL),
	(29,'องค์การบริหารส่วนตำบลพังราด',2,NULL,NULL,NULL),
	(30,'องค์การบริหารส่วนตำบลวังหว้า',2,NULL,NULL,NULL),
	(31,'องค์การบริหารส่วนตำบลคลองปูน',2,NULL,NULL,NULL),
	(32,'องค์การบริหารส่วนตำบลกองดิน',2,NULL,NULL,NULL),
	(33,'องค์การบริหารส่วนตำบลห้วยยาง',2,NULL,NULL,NULL),
	(34,'เทศบาลตำบลมาบข่า',3,NULL,NULL,NULL),
	(35,'เทศบาลตำบลมะขามคู่',3,NULL,NULL,NULL),
	(36,'เทศบาลตำบลมาบข่าพัฒนา',3,NULL,NULL,NULL),
	(37,'องค์การบริหารส่วนตำบลนิคมพัฒนา',3,NULL,NULL,NULL),
	(38,'องค์การบริหารส่วนตำบลพนานิคม',3,NULL,NULL,NULL),
	(39,'เทศบาลตำบลชำฆ้อ',4,NULL,NULL,NULL),
	(40,'องค์การบริหารส่วนตำบลเขาชะเมา',4,NULL,NULL,NULL),
	(41,'องค์การบริหารส่วนตำบลเขาน้อย',4,NULL,NULL,NULL),
	(42,'องค์การบริหารส่วนตำบลน้ำเป็น',4,NULL,NULL,NULL),
	(43,'เทศบาลตำบลชุมแสง',5,NULL,NULL,NULL),
	(44,'องค์การบริหารส่วนตำบลชุมแสง',5,NULL,NULL,NULL),
	(45,'องค์การบริหารส่วนตำบลป่ายุบใน',5,NULL,NULL,NULL),
	(46,'องค์การบริหารส่วนตำบลวังจันทร์',5,NULL,NULL,NULL),
	(47,'องค์การบริหารส่วนตำบลพลงตาเอี่ยม',5,NULL,NULL,NULL),
	(48,'เทศบาลเมืองบ้านฉาง',6,NULL,NULL,NULL),
	(49,'เทศบาลตำบลบ้านฉาง',6,NULL,NULL,NULL),
	(50,'เทศบาลตำบลพลา',6,NULL,NULL,NULL),
	(51,'เทศบาลตำบลสำนักท้อน',6,NULL,NULL,NULL),
	(52,'องค์การบริหารส่วนตำบลสำนักท้อน',6,NULL,NULL,NULL),
	(53,'เทศบาลตำบลบ้านปลวกแดง',7,NULL,NULL,NULL),
	(54,'เทศบาลตำบลจอมพลเจ้าพระยา',7,NULL,NULL,NULL),
	(55,'องค์การบริหารส่วนตำบลปลวกแดง',7,NULL,NULL,NULL),
	(56,'องค์การบริหารส่วนตำบลตาสิทธิ์',7,NULL,NULL,NULL),
	(57,'องค์การบริหารส่วนตำบลละหาร',7,NULL,NULL,NULL),
	(58,'องค์การบริหารส่วนตำบลแม่น้ำคู้',7,NULL,NULL,NULL),
	(59,'องค์การบริหารส่วนตำบลมาบยางพร',7,NULL,NULL,NULL),
	(60,'องค์การบริหารส่วนตำบลหนองไร่',7,NULL,NULL,NULL),
	(61,'เทศบาลตำบลบ้านค่าย',8,NULL,NULL,NULL),
	(62,'เทศบาลตำบลบ้านค่ายพัฒนา',8,NULL,NULL,NULL),
	(63,'เทศบาลตำบลชากบก',8,NULL,NULL,NULL),
	(64,'องค์การบริหารส่วนตำบลตาขัน',8,NULL,NULL,NULL),
	(65,'องค์การบริหารส่วนตำบลหนองตะพาน',8,NULL,NULL,NULL),
	(66,'องค์การบริหารส่วนตำบลหนองละลอก',8,NULL,NULL,NULL),
	(67,'องค์การบริหารส่วนตำบลหนองบัว',8,NULL,NULL,NULL),
	(68,'องค์การบริหารส่วนตำบลบางบุตร',8,NULL,NULL,NULL);
...
VALUES
	...
	(26,'ตำบลกระแสบน',6),
	(27,'ตำบลบ้านนา',6),
	(28,'ตำบลทุ่งควายกิน',6),
	(29,'ตำบลกองดิน',6),
	(30,'ตำบลคลองปูน',6),
	(31,'ตำบลพังราด',6),
	(32,'ตำบลปากน้ำกระแส',6),
	(33,'ตำบลห้วยยาง',6),
	(34,'ตำบลสองสลึง',6),
	(35,'ตำบลวังจันทร์',5),
	(36,'ตำบลชุมแสง',5),
	(37,'ตำบลป่ายุบใน',5),
	(38,'ตำบลพลงตาเอี่ยม',5),
	(39,'ตำบลบ้านค่าย',8),
	(40,'ตำบลหนองละลอก',8),
	(41,'ตำบลหนองตะพาน',8),
	(42,'ตำบลตาขัน',8),
	...
	(66,'ตำบลชากพง',2),
	(67,'ตำบลทางเกวียน',2),
	(68,'ตำบลทุ่งควายกิน',2),
	(69,'ตำบลบ้านนา',2),
	(70,'ตำบลปากน้ำกระแส',2),
	(71,'ตำบลพังราด',2),
	(72,'ตำบลวังหว้า ',2),
	(73,'ตำบลสองสลึง',2),
	(74,'ตำบลห้วยยาง',2);
